...
const DOCUMENT_LIST_FILTER = `_type == 'animal`
const DOCUMENT_LIST_QUERY = `* [_type == 'animal'] {_id, _type}`

const METADATA_LIST_FILTER = `_type == publish.metadata`
const METADATA_LIST_QUERY = `*[_type == 'publish.metadata'] {
  _id,
  documentId,
  revId,
  "reference": coalesce(
